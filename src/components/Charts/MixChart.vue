...
<script>
  ...
  import { statistics } from '@/network/statistics-mgmt'
    ...
    methods: {
      ...
      initStatistics() {
        ...
        statistics().then(response => {
          ...
          this.yAxisMin = response.data.data.yAxisMin
          this.yAxisMax = response.data.data.yAxisMax
          this.yAxisInterval = response.data.data.yAxisInterval
